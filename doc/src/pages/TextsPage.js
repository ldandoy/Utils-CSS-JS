...
const TextsPage= () => {
    ...
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab provident aliquam eos hic dolor aut doloremque inventore sint. Quis, dignissimos recusandae! Ea numquam aspernatur assumenda tenetur a autem, nihil quo?
                ...
                <div className="row">
                    <div className="col">
                        <HighlightCode code={`<div class="txt-justify mt-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab <span class="txt-overline">provident aliquam</span> eos hic dolor aut doloremque inventore sint. Quis, dignissimos recusandae! Ea numquam aspernatur assumenda tenetur a autem, nihil quo?
    ...
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab provident aliquam eos hic dolor aut doloremque inventore sint. Quis, dignissimos recusandae! Ea numquam aspernatur assumenda tenetur a autem, nihil quo?
            ...
            <section className="mb-60 ">
                <div className="row mb-20">
                    <div className="col">
                        <h2>Autre className possible</h2>
                    </div>
                </div>
                <div className="row row-half">
                    <div className="col col-half">
                        <HighlightCode code={`<!-- For text in bold: .txt-bold -->
...
<div class="txt-wavy">Texte</div>`} translateToReact language='htmlbars' />
                    </div>
                    <div className="col col-half">
                        <HighlightCode code={`<!-- For text in small: .txt-small -->
...
<div class="txt-xl">Texte</div>`} translateToReact language='htmlbars' />

                        <HighlightCode code={`<!-- For text in line-height-sm: .txt-line-height-sm -->
...
<div class="txt-line-height-xl">Texte</div>`} translateToReact language='htmlbars' />

                        <HighlightCode code={`<!-- For text size form 8px to 30px: .txt-size-8 -->
<div class="txt-size-21">Texte</div>

<!-- For text form 30px to 100px five by five: .txt-size-55 -->
<div class="txt-size-70">Texte</div>`} translateToReact language='htmlbars' />
                    </div>
                </div>
            </section>
        </div>
